...
7. Print- The print() function is a simple and powerful way to display information in Python. It helps in showing results, debugging programs, and interacting with users.

8. APPLICATIONS OF PYTHON-Web development, Data science and Machine Learning, Artificial Intelligence, Automation and scripting, Game development, Scientific computing and Desktop applications
...
# CONCLUSION
Python is a powerful, simple, and versatile programming language that is easy to learn. Its clear syntax helps beginners understand programming concepts quickly, while its large collection of libraries makes it useful for solving real-world problems efficiently. 
